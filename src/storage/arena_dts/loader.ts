...
export function loadDeclaration(sourceFilePath: string): DeclarationContent[] {
    ...
    const classes: DeclarationContent[] = sourceFile
        .getClasses()
        .map((declaration) => {
            return {
                type: "class",
    ...
    const enums: DeclarationContent[] = sourceFile
        .getEnums()
        .map((declaration) => {
            return {
                type: "enum",
    ...
    const functions: DeclarationContent[] = sourceFile
        .getFunctions()
        .map((declaration) => {
            return {
                type: "function",
    ...
    const classes_full: DeclarationContent[] = sourceFile
        .getClasses()
        .map((declaration) => {
            return {
                type: "class_full",
